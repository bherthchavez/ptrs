...
<!-- end of header  -->
                    ...
                    $query = $mysqli->query("SELECT * FROM players WHERE  Passport_No= '$_SESSION[Passport_No_Normal]' ") or die(mysqli_error());
      ...
      <div style = "width:40%; margin-left:30%;"> 
           ...
           <p> Contact the administrator <br/> to update your information! </p>
                   ...
                   <div class = "form-group">
                    <a  href="Player_Normal.php" class = "btn btn-primary form-control" name = "back" type="button" style="width: 92%; height: auto;"><span class = "glyphicon glyphicon-save" ></span>Add New Player</a>
                     <a  href="Home_No.php" type="button" class = "btn btn-back form-control" name = "back" style="width: 92%; height: auto;"><span class = "glyphicon glyphicon-save" ></span>Home</a>
                      <a  href="logout.php" type="button" class = "btn btn2 form-control" name = "back" style="width: 92%; height: auto;"><span class = "glyphicon glyphicon-save" ></span>Logout</a>
                  </div>
