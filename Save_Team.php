...
$mysqli->query("INSERT INTO team  VALUES ('', '$Team_Name', '$Team_Name', '$District', '$Organization', '$Jersey_Color', '$Captain_Name', '$Player_2', '$Player_3', '$Player_4', '$Player_5', '$Player_6', '$Player_7', '$Player_8', '$Player_9', '$Player_10', '$Player_11', '$Player_12', '$Player_13', '$Player_14', '$Player_15', '$Player_16', '$Player_17', '$Player_18', '$Player_19', '$Player_20', '$Player_21', '$Player_22', '$Player_23', '$Player_24', '$M_Contact', '$M_Email', '$C_Contact', '$C_Email', '$date')") or die(mysqli_error());
