...
<form method = "POST" enctype = "multipart/form-data" action = "Save_Player_Normal.php">
...
<div class = "col-5">
 ...
 style="width: 100%; height: auto;">
                   ...
                   <div class = "form-group">
                    <a  href="Home_No.php" type="button" class = "btn btn-back form-control" name = "back" style="width: 100%; height: auto;"><span class = "glyphicon glyphicon-save" ></span>Back</a>
                  </div>
