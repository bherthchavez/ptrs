...
<!-- end of header  -->
                    ...
                    <?php
                    $query = $conn->query("SELECT * FROM Players WHERE  Player_Code= '$_REQUEST[Player_Code]' ") or die(mysqli_error());
...
<form method = "POST" enctype = "multipart/form-data" action = "Save_Player_Edit.php?Player_Code=<?php echo $fetch['Player_Code']?>">
...
<div class = "col-5">
                  <div class = "form-group">
                    ...
                    <input type = "text" class = "form-control"  name = "Team_Name" value = "<?php echo $fetch['Team_Name']?>"  required=" " autofocus />
                  </div>
                  <div class = "form-group">
                    <label>DISTRICT</label>
                    <input type = "text" class = "form-control"  name = "DISTRICT" value = "<?php echo $fetch['District']?>" required=" "/>
                  </div>
                  <div class = "form-group">
                    <label>Name as in Passsport</label>
                    <input type = "text" class = "form-control"  name = "Passsport_Name" value = "<?php echo $fetch['Name_in_Passport']?>"  required=" " />
                  </div>
                  <div class = "form-group">
                    <label>Passport No.</label>
                    <input type = "text" class = "form-control"  name = "Passport_No" value = "<?php echo $fetch['Passport_No']?>"  required=" " />
                  </div>

                   <div class = "form-group">
                    <label>Qatar I.D No.</label>
                    <input type = "text" class = "form-control"  name = "QID" value = "<?php echo $fetch['Qatar_ID']?>"  required=" " />
                  </div>
                 
                  <div class = "form-group">
                    <label>Validity</label>
                    <input type = "text" class = "form-control"  name = "Validity" value = "<?php echo $fetch['Validity']?>"  required=" " />
                  </div>
                  <br>
                  <br>
                   <div class = "form-group">
                    <label>Date of Birth  (Eg. 12 Aug 1987)</label>
                    <input type = "text" class = "form-control"  name = "Bday" value = "<?php echo $fetch['Date_of_Birth']?>"  required=" " />
                  </div>
                   <div class = "form-group">
                    <label>Name of the Sponsor</label>
                    <input type = "text" class = "form-control"  name = "Sponsor" value = "<?php echo $fetch['Name_of_Sponsor']?>"  required=" " />
                  </div>
                   <div class = "form-group">
                    <label>Tel (Doha)</label>
                    <input type = "text" class = "form-control"  name = "Tel" value = "<?php echo $fetch['Tel']?>" required=" " />
                  </div>
                  <div class = "form-group">
                    <label>Address as in the Passport with Telephone No(India)</label>
                    <textarea name="Address" style="height:100px; resize:none;"  class="form-control"  required=" "><?php echo $fetch['Address']?></textarea>
                  </div>
 ...
 style="width: 100%; height: auto;">
                   ...
                   <div class = "form-group">
                    <a  href="Player_View.php?Player_Code=<?php echo $fetch['Player_Code']?>" type="button" class = "btn btn-back form-control" name = "back" style="width: 100%; height: auto;"><span class = "glyphicon glyphicon-save" ></span>Back</a>
                  </div>
